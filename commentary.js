...
const nextEventButton = document.getElementById("next-event-button");
    ...
    { time: "22'", description: "Neymar percute en dribbles, mais sa passe vers Messi est interceptée.", type: "missed", team: "Barcelona" },
    ...
    { time: "80'", description: "Belle percée de Messi, mais sa tentative de dribble autour de Marquinhos échoue.", type: "missed", team: "Barcelona" },
